 ...
 */
Blockly.HSV_SATURATION = 1; //0.45;
/**
 * The intensity of block colours, regardless of the hue.
 * Must be in the range of 0 (inclusive) to 1 (exclusive).
 */
Blockly.HSV_VALUE = 0.8; //0.65;
...
/**
 * ENUM for a dummy input.  Used to add field(s) with no input.
 * @const
 */
Blockly.DUMMY_INPUT = 5;
/**
 * ENUM for a nominative right-facing value input. ***
 * @const
 */
Blockly.NOMINATIVE_INPUT_VALUE = 6;
/**
 * ENUM for a nominative left-facing value input. ***
 * @const
 */
Blockly.NOMINATIVE_OUTPUT_VALUE = 7;
/**
 * ENUM for a genitive right-facing value input. ***
 * @const
 */
Blockly.GENITIVE_INPUT_VALUE = 8;
/**
 * ENUM for a genitive left-facing value input. ***
 * @const
 */
Blockly.GENITIVE_OUTPUT_VALUE = 9;
/**
 * ENUM for a dative right-facing value input. ***
 * @const
 */
Blockly.DATIVE_INPUT_VALUE = 10;
/**
 * ENUM for a dative left-facing value input. ***
 * @const
 */
Blockly.DATIVE_OUTPUT_VALUE = 11;
/**
 * ENUM for an accusative right-facing value input. ***
 * @const
 */
Blockly.ACCUSATIVE_INPUT_VALUE = 12;
/**
 * ENUM for an accusative left-facing value input. ***
 * @const
 */
Blockly.ACCUSATIVE_OUTPUT_VALUE = 13;
/**
 * ENUM for a ablative right-facing value input. ***
 * @const
 */
Blockly.ABLATIVE_INPUT_VALUE = 14;
/**
 * ENUM for a ablative left-facing value input. ***
 * @const
 */
Blockly.ABLATIVE_OUTPUT_VALUE = 15;
/**
 * ENUM for a ablative right-facing value input. ***
 * @const
 */
Blockly.VOCATIVE_INPUT_VALUE = 16;
/**
 * ENUM for a ablative left-facing value input. ***
 * @const
 */
Blockly.VOCATIVE_OUTPUT_VALUE = 17;
...
//***
Blockly.OPPOSITE_TYPE[Blockly.NOMINATIVE_INPUT_VALUE] = Blockly.NOMINATIVE_OUTPUT_VALUE;
Blockly.OPPOSITE_TYPE[Blockly.NOMINATIVE_OUTPUT_VALUE] = Blockly.NOMINATIVE_INPUT_VALUE;
Blockly.OPPOSITE_TYPE[Blockly.GENITIVE_INPUT_VALUE] = Blockly.GENITIVE_OUTPUT_VALUE;
Blockly.OPPOSITE_TYPE[Blockly.GENITIVE_OUTPUT_VALUE] = Blockly.GENITIVE_INPUT_VALUE;
Blockly.OPPOSITE_TYPE[Blockly.DATIVE_INPUT_VALUE] = Blockly.DATIVE_OUTPUT_VALUE;
Blockly.OPPOSITE_TYPE[Blockly.DATIVE_OUTPUT_VALUE] = Blockly.DATIVE_INPUT_VALUE;
Blockly.OPPOSITE_TYPE[Blockly.ACCUSATIVE_INPUT_VALUE] = Blockly.ACCUSATIVE_OUTPUT_VALUE;
Blockly.OPPOSITE_TYPE[Blockly.ACCUSATIVE_OUTPUT_VALUE] = Blockly.ACCUSATIVE_INPUT_VALUE;
Blockly.OPPOSITE_TYPE[Blockly.ABLATIVE_INPUT_VALUE] = Blockly.ABLATIVE_OUTPUT_VALUE;
Blockly.OPPOSITE_TYPE[Blockly.ABLATIVE_OUTPUT_VALUE] = Blockly.ABLATIVE_INPUT_VALUE;
Blockly.OPPOSITE_TYPE[Blockly.VOCATIVE_INPUT_VALUE] = Blockly.VOCATIVE_OUTPUT_VALUE;
Blockly.OPPOSITE_TYPE[Blockly.VOCATIVE_OUTPUT_VALUE] = Blockly.VOCATIVE_INPUT_VALUE;
/**
...
Blockly.onKeyDown_ = function(e) {
  ...
  if (e.keyCode == 27) {
    ...
    // Delete or backspace.
    try {
      if (Blockly.selected && Blockly.selected.deletable_) {
        Blockly.hideChaff();
    ...
    if (Blockly.selected &&
        Blockly.selected.deletable_ && Blockly.selected.isMovable() &&
