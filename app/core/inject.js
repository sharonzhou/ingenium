...
Blockly.createDom_ = function(container) {
  ...
  */
  ...
  Blockly.createSvgElement('path',
      {'d': '', 'stroke': '#222'}, pattern); // *** CHANGED DISABLED PATTERN TO NO STRIPES
        ...
        if (Blockly.dragMode_ == 0) {
          ...
          if (metrics.contentTop < edgeTop ||
            ...
            for (var b = 0, block; block = blocks[b]; b++) {
              ...
              var overflow = edgeTop - blockXY.y + HIGHLIGHT;
              if (overflow > 0) {
                block.moveBy(0, overflow);
              }
              // Bump any block that's below the bottom back inside.
              // var overflow = edgeTop + metrics.viewHeight - MARGIN - blockXY.y;
              var overflow = edgeTop + metrics.viewHeight - blockXY.y - blockHW.height - HIGHLIGHT*2;
              if (overflow < 0) {
                block.moveBy(0, overflow);
              }
              ...
              if (block.getFieldValue("noun-clamp") != null || 
                  block.nominativeOutputConnection != null ||
                  block.genitiveOutputConnection != null ||
                  block.dativeOutputConnection != null ||
                  block.accusativeOutputConnection != null ||
                  block.ablativeOutputConnection != null ||
                  block.vocativeOutputConnection != null ||
              ...
              var overflow = edgeLeft + metrics.viewWidth - blockXY.x - blockHW.width - HIGHLIGHT*4;
              if (block.getFieldValue("noun-clamp") != null || 
                  block.nominativeOutputConnection != null ||
                  block.genitiveOutputConnection != null ||
                  block.dativeOutputConnection != null ||
